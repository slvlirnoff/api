...
module.exports = function( vs ){
  ...
  vs.var(`multi_match:${view_name}:fields`, toMultiFields(vs.var('phrase:field').get(), vs.var('lang').get()));
  ...
  vs.var(`multi_match:${view_name}:minimum_should_match`).set(vs.var('ngram:minimum_should_match').get());
